...
> **快照时间**：2026-09-14 20:55 ｜ **最新完成**：**M3.6 HTTP 层测试收尾（44 端点信封/鉴权全审计 + 行为回归，单测 825 例全绿；冒烟 43/43）** ｜ **下一里程碑**：M3.7 文档与部署说明 ｜ **进行中**：阶段 2 与阶段 3 **并行**（GPU 空档跑实验，人工时间推 M3）
>
...
**待办**：M3.7 文档与部署说明；阶段 2 剩余 GPU 实验按 [gpu-queue.md](gpu-queue.md) 补跑。
